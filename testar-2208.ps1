...
Write-Host "=== TESTANDO CODIGO 2208 NO RENDER ===" -ForegroundColor Cyan
Write-Host ""

$url = "https://maxiptv-update-1.onrender.com/?code=2208"

try {
    $r = Invoke-RestMethod -Uri $url -Method Get -TimeoutSec 25
