...
fun SeriesDetailsScreen(nav: NavHostController, seriesId: Int) {
  ...
  // ⚡ OTIMIZAÇÃO: Processar idiomas disponíveis com derivedStateOf para cachear resultado
  ...
  LaunchedEffect(seriesId, allSeries, selectedLanguage) {
    ...
    // ⚡ OTIMIZAÇÃO: Removido delay desnecessário - StateFlow já atualiza instantaneamente
